...
GFX_VTABLE __linear_vtable24 =
{
   ...
   NULL, // _linear_draw_rle_sprite24,
   NULL, // _linear_draw_trans_rle_sprite24,
   NULL, // _linear_draw_trans_rgba_rle_sprite24,
   NULL, // _linear_draw_lit_rle_sprite24,
   _linear_draw_character24,
   NULL, // _linear_draw_glyph24,
   _linear_blit24,
   _linear_blit24,
   _linear_blit24,
   _linear_blit24,
